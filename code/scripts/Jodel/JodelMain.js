...
import {rowsToObjects,rndHex,getColumn,getAllIndexes,getKeyByValue} from '../Common/common_functions.js'
...
var displayX = document.getElementById("densityX");
displayX.addEventListener('change',displayMain);

var displayY = document.getElementById("densityY");
displayY.addEventListener('change',displayMain);
